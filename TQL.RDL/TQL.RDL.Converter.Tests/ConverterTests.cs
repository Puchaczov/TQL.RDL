...
namespace TQL.RDL.Converter.Tests
{
    ...
    public class ConverterTests
    {
        ...
        public void Converter_CheckIsMethodRegistered_ShouldPass()
        {
            ...
            var request = new ConvertionRequest("repeat every 5 seconds where TestA(@current) and TestB(@current) start at '2016/06/06 14:00:00'", DateTimeOffset.Parse("2016/06/06 14:00:00"), methods);
